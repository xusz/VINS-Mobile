...
{
public:
    KeyFrame(double _header,
             int _global_index,
             Eigen::Vector3d _T_w_c,
             Eigen::Matrix3d _R_w_c,
             cv::Mat &_image,
    ...
    void updatePose(const Eigen::Vector3d &_T_w_i,
                    const Eigen::Matrix3d &_R_w_i);
    
    void updateOriginPose(const Eigen::Vector3d &_T_w_i,
                          const Eigen::Matrix3d &_R_w_i);
    ...
    void updateLoopConnection(Vector3d relative_t,
                              Quaterniond relative_q,
                              double relative_yaw);
